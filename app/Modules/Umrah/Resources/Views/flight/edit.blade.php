...
@section('title', 'Umrah  Flight Edit')
...
@section('content')
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10" ng-controller="ContactEditController">
            {!! Form::open(['url' => array('umrah/flight/update', 1), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']) !!}
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-1-1 uk-float-right">
                                            ...
                                            <a href="{{ route('Umrah_Flight') }}" type="button" class="md-btn md-btn-flat uk-modal-close">Close</a>
                                        </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $('#Umrah_Flight').addClass('act_item');
    </script>>
@endsection