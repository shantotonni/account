                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                        ...
                                        @foreach($police as $value)
                                            ...
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    ...
                                                    <a href="{{ route('Umrah_Visa_Processing_edit',$value->id) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
                                ...
                                <div class="md-fab-wrapper branch-create">
                                    <a id="add_branch_button" href="{{ route('Umrah_Visa_Processing_create') }}" class="md-fab md-fab-accent branch-create">
