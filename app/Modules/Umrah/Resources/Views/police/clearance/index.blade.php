                                        ...
                                        @foreach($police as $value)
                                            ...
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    ...
                                                    <a href="{{ route('Umrah_Police_Clearence_edit',$value->id) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#Umrah_Police_Clearence').addClass('act_item');
    </script>
@endsection