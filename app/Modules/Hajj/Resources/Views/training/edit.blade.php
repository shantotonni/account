...
@section('title', 'Hajj  Training Edit')
...
@section('content')
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10" ng-controller="ContactEditController">
            {!! Form::open(['url' => array('hajj/visa/processing/update', 1), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']) !!}
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="md-fab-wrapper branch-create">
                                        <a id="add_branch_button" href="{{ route('Hajj_Training_create') }}" class="md-fab md-fab-accent branch-create">
