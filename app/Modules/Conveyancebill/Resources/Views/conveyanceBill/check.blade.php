...
@endif
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('cnb_check_update' , $information->id), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form']) !!}
                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">Conveyance Bill</span></h2>
                                </div>
                            </div>
                                            ...
                                            <div class="uk-form-row">
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    ...
                                                    <div class="uk-width-medium-1-1">
                                                        <textarea class="md-input" name="comment" id="item_about" cols="30" rows="4">{{ $information->comments?$information->comments:'' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
