                    ...
                    <div class="md-card">
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <div class="user_heading_content">
                                <h2 class="heading_b"><span class="uk-text-truncate">Create New Role</span></h2>
                            </div>
                        </div>
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('role_store'), 'method' => 'POST']) !!}
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        ...
                                        <textarea class="md-input" name="description" id="description" cols="30" rows="4"></textarea>
