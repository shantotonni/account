...
@section('title', 'Opening Balance Create')
                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('setting_openingbalance_store'), 'method' => 'POST']) !!}
                                ...
                                <div class="uk-grid" style="margin: 0 auto">
                                    <table class="uk-table"  cellspacing="0" width="80%" style="text-align: center;">
                                        ...
                                        @foreach($journal_up as $value)
                                            ...
                                            <tr>
                                                <td width="40%">{{ $value->account_name }}</td>

                                                    <td width="30%"><input onkeypress='return event.charCode==46 || event.charCode >= 48 && event.charCode <= 57' onkeyup="accountcheck(this)" onchange="accountcheck(this)" style="size: 10px;padding: 5px;direction: rtl;" type="text" value=""  id="{{ $value->id }}_dbt" name="{{ $value->id }}_dbt" ></td>
                                    ...
                                    <table class="uk-table" cellspacing="0" width="80%" id="data_table" style="text-align: center;">
                                        ...
                                        <tr style="padding: 10px; margin: 5px; color: black">
                                            ...
                                            <td width="30%" ><input type="text" id="adjustdebit"  name="7_dbt" style="direction: rtl; border:none;" />(BDT)</td>
                                            <td width="30%" ><input type="text" size="15" id="adjustcredit"  name="7_crt" style="direction: rtl; border:none;" />(BDT)</td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="uk-grid">
