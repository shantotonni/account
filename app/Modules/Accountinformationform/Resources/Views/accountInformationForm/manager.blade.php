...
@endif
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('aif_manager_update' , $manager->id), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form']) !!}
                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">Manager Approval</span></h2>
                                </div>
                            </div>
                                        ...
                                        <div class="uk-width-medium-1-7">
                                            <div class="uk-form-row">
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    ...
                                                    <div class="uk-width-medium-1-5">
                                                    <p>
                                                    <label class="inline-label"><input {{ $manager->signature_of_manager==1? "checked":'' }} type="radio" name="signature_of_manager" value="1" data-md-icheck/>
                                                     Approve</label>
                                                    </p>
                                                    </div>
                                                    <div class="uk-width-medium-1-5">
                                                    <p>
                                                    <label class="inline-label"><input {{ $manager->signature_of_manager==0? "checked":'' }} type="radio" name="signature_of_manager" value="0" data-md-icheck/>
                                                     Dis-Approve</label>
                                                    </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="uk-form-row">
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    ...
                                                    <div class="uk-width-medium-1-1">
                                                        <textarea class="md-input" name="manager_comment" id="item_about" cols="30" rows="4">{{ $manager->manager_comment?$manager->manager_comment:'' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
