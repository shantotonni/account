...
@endif
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('aif_admin_update' , $admin->id), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form']) !!}
                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">Admin Approval</span></h2>
                                </div>
                            </div>
                                        ...
                                        <div class="uk-width-medium-1-7">
                                            <div class="uk-form-row">
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    ...
                                                    <div class="uk-width-medium-1-5">
                                                    <p>
                                                    <label class="inline-label"><input {{ $admin->signature_of_admin==1? "checked":'' }} type="radio" name="signature_of_admin" value="1" data-md-icheck/>
                                                     Approve</label>
                                                    </p>
                                                    </div>
                                                    <div class="uk-width-medium-1-5">
                                                    <p>
                                                    <label class="inline-label"><input {{ $admin->signature_of_admin==0? "checked":'' }} type="radio" name="signature_of_admin" value="0" data-md-icheck/>
                                                     Dis-Approve</label>
                                                    </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="uk-form-row">
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    ...
                                                    <div class="uk-width-medium-1-1">
                                                        <textarea class="md-input" name="admin_comment" id="item_about" cols="30" rows="4">{{ $admin->admin_comment?$admin->admin_comment:'' }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
