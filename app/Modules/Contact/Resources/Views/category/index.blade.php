                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-overflow-container uk-margin-bottom">
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            <td>{{ $count++ }}</td>
                                            <td>{{ $category->contact_category_name }}</td>
                                            <td>{{ substr($category->contact_category_description, 0, 50) }}</td>
                                            {{--<td>{{ $category->updatedBy->name }}</td>--}}
                                            {{--<td>{{ $category->updated_at }}</td>--}}
                                            {{--<td class="uk-text-center">--}}
                                                {{--<a href="{{ route('category_edit',['id' => $category->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>--}}
                            ...
                            {{--<div class="md-fab-wrapper branch-create">--}}
                                {{--<a id="add_branch_button" href="{{ route('category_create') }}" class="md-fab md-fab-accent branch-create">--}}
    ...
    <script>
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "/contact/category/delete/"+id;
            })
        })
    </script>
