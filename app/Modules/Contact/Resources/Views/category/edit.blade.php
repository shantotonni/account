                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-margin-top">
                                {!! Form::open(['url' => route('category_update', ['id' => $category->id]), 'method' => 'POST']) !!}
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="contact_category_name" name="contact_category_name" value="{{ old('contact_category_name') ? old('contact_category_name') : $category->contact_category_name }}" required/>
                                    ...
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-width-medium-4-5">
                                            ...
                                            <textarea class="md-input" name="contact_category_description" id="contact_category_description" cols="30" rows="4" required>{{ old('contact_category_description') ? old('contact_category_description') : $category->contact_category_description }}</textarea>
