...
@section('content')
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            @endif
            {!! Form::open(['url' => route('manpower_service_hotel_update',$progress->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']) !!}
                            ...
                            <div class="uk-margin-top">
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="name" value="{!! $progress->title !!}" name="title">
                                        @if($errors->has('title'))
                                            <br/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <textarea type="text" name="note" id="note" class="md-input" cols="4" rows="4">{!! $progress->note !!}</textarea>
                                    </div>
                                </div>
                                <br>
                                <br>
