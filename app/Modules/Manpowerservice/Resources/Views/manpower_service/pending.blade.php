                                    ...
                                    @foreach($manpower as $value)
                                        <tr>
                                            ...
                                            <td class="uk-text-center">
                                                <a href="{{ route('manpower_service_pendingUpdate',['id' => $value->id]) }}"><i title="pending" class="md-icon material-icons">&#xE88E;</i></a>
                                                <a href="{{ route('manpower_service_pdf',['id' => $value->id]) }}"><i class="material-icons">&#xE415;</i></a>
                                                <a href="{{ route('manpower_service_bill_show',['id' => $value->bill_id?$value->bill_id:0,'order'=>$value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons {{$value->bill_id?' md-color-light-green-700': ''}}">B</i></a>
                                                <a href="{{ route('manpower_service_invoice_show',['id' => $value->invoice_id?$value->invoice_id:0,'order'=>$value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons {{$value->invoice_id?' md-color-light-green-700': ''}}">I</i></a>
