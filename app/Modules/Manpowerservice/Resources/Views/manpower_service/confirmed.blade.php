...
@section('title', 'Manpower Service')
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        {!! Form::open(['url' => 'manpower/service/confirmed', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']) !!}
                                    ...
                                    @foreach($manpower as $value)
                                        <tr>
                                            ...
                                            <td class="uk-text-center">
                                                ...
                                                <a href="{{ route('manpower_service_bill_show',['id' => $value->bill_id?$value->bill_id:0,'progress'=>$value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons {{$value->bill_id?' md-color-light-green-700': ''}}">B</i></a>
                                                <a href="{{ route('manpower_service_invoice_show',['id' => $value->invoice_id?$value->invoice_id:0,'progress'=>$value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons {{$value->invoice_id?' md-color-light-green-700': ''}}">I</i></a>
                                                <a href="{{ route('manpower_service_edit',['id' => $value->id]) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
                                                ...
                                                <a href="{!! route('manpower_service_sendMail',$value->id) !!}"><i class="material-icons">&#xE0BE;</i></a>
