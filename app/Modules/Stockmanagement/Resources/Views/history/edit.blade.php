                                ...
                                <div class="uk-margin-top">
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label for="item_category_id" class="uk-vertical-align-middle">Issued By</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                            <select id="item_category_id" name="item_category_id" data-md-selectize>
                                                <option value="">Select Issue Creator</option>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="total_item">Total Entry</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                            <label for="total_item">Entry Amount</label>
                                            <input class="md-input" type="text" id="total_item" name="total_item " />
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="total_item">Date</label>
                                        </div>
                                        <div class="uk-width-medium-2-5">
                                            <label for="total_item">Entry Date</label>
                                            <input class="md-input" type="text" id="total_item" name="total_item " />
                                        </div>
                                    </div>
                                    <div class="uk-grid">
