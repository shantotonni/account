...
<div class="uk-modal" id="modal_header_footer1" ng-controller="ExcessPaymentController">
    <div class="uk-modal-dialog">
        <div class="uk-modal-header">
            <h3 class="uk-modal-title">Use Excess Payment for INV-{{ str_pad($invoice->invoice_number, 6, '0', STR_PAD_LEFT) }}</h3>Invoice Balance: BDT {{ $helper->getDueBalance($invoice->id) }}
        </div>
        {!! Form::open(['url' => route('post_excess_payment'), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']) !!}
