...
@section('title', 'Customer Medical')
                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{!! $i++ !!}</td>
                                <td>{!! isset($recruit->paxid)?$recruit->paxid:'' !!}</td>
                                <td>{!! isset($recruit->dateOfApplication)?$recruit->dateOfApplication:'' !!}</td>

                                <td class="uk-text-center">
                                    <a href="{!! route('medical_slip_form_edit',isset($recruit->medicalslip_id)?$recruit->medicalslip_id:'') !!}"  class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                </td>
