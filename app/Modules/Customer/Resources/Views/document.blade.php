...
@section('title', 'Customer Document')
                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tr>
                            ...
                            <td>{!! isset($recruit->document->Category['categoryName'])? $recruit->document->Category['categoryName']:'' !!}</td>
                            <td>{!! $recruit->paxid  !!}</td>
                            <td>{!! $recruit->document['title']  !!}</td>

                            @if($recruit->id==$recruit->document['pax_id'])
                                <td class="uk-text-center">
                                    <a href="{!! route('document_edit',$recruit->id) !!}" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                </td>
                            @else
                                <td class="uk-text-center">
                                    <a href="{!! route('document_create',$recruit->id) !!}" class="batch-edit"><i class="md-icon material-icons uk-margin-right">+</i></a>
                                </td>
                            @endif
