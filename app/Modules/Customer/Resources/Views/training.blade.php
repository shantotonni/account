                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{!! $i++ !!}</td>
                                <td>{!! $recruit->training['received_date'] !!}</td>
                                <td>{!! $recruit->paxid !!}</td>
                                <td>{!! $recruit->training['number'] !!}</td>
                                <td>{!! $recruit->training['center_name'] !!}</td>

                                @if($recruit->id==$recruit->training['paxid'])
                                    <td class="uk-text-center">
                                        <a href="{!! route('training_edit',$recruit->id) !!}" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                    </td>
                                @else
                                    <td class="uk-text-center">
                                        <a href="{!! route('training_create',$recruit->id) !!}" class="batch-edit"><i class="md-icon material-icons uk-margin-right">+</i></a>
                                    </td>
                                @endif
