                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    {!! Form::open(['url' => route('document_cateregory_store'), 'method' => 'POST']) !!}
                                        <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-grid">
                                            ...
                                            <div class="uk-width-medium-4-5">
                                                ...
                                                <textarea class="md-input" name="contact_category_description" id="contact_category_description" cols="30" rows="4" required>{{old('contact_category_description')}}</textarea>
