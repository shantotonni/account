...
@endif
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
            {!! Form::open(['url' => route('reception_category_store'), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form' , 'onsubmit' => 'return valid();']) !!}
                    ...
                    <div class="uk-width-large-10-10">
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                        <label class="uk-vertical-align-middle" for="customer_name">Summary</label>
                                    </div>
                                    <div class="uk-width-medium-2-5">
                                        <label>Summary</label>
                                        <textarea cols="30" rows="4" class="md-input" name="summary"></textarea>
                                    </div>
                                </div>
