                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">Reception Category</span></h2>
                                </div>
                            </div>
                            <div class="user_content">
                                        ...
                                        @foreach($category as $all)
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    ...
                                                    <a href="{{ route('reception_category_show', $all->id) }}"><i data-uk-tooltip="{pos:'top'}" title="View" class="md-icon material-icons">visibility</i></a>
                                                    <a href="{{ route('reception_category_edit', $all->id) }}"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
                                                    <a class="delete_btn"><i data-uk-tooltip="{pos:'top'}" title="Delete" class="md-icon material-icons">&#xE872;</i></a>
                                                    <input class="inventory_id" type="hidden" value="{{ route('reception_category_delete',$all->id) }}">
                                ...
                                <a id="add_branch_button" href="{{ route('reception_category_create') }}" class="md-fab md-fab-accent branch-create">
