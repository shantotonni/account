...
class CreatePaymentMadeEntryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('payment_made_entry', function (Blueprint $table) {
            $table->increments('id');
            $table->double('amount');
        ...
        Schema::table('payment_made_entry', function(Blueprint $table){
    ...
    {
        Schema::dropIfExists('payment_made_entry');
    }
}
