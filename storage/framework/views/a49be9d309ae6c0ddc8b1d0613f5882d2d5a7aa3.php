<?php $__env->startSection('title', 'Estimate Edit'); ?>
...
<?php $__env->startSection('angular'); ?>
    ...
    <script src="<?php echo e(url('app/moneyin/invoice/estimateEdit.controller.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <div class="uk-grid" ng-controller="InvoiceEditController">
        <div class="uk-width-large-10-10">
            <?php echo Form::open(['url' => route('estimate_update',['id' => $estimate->id]), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']); ?>

            <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">

                        <input type="hidden" ng-init="invoice_id='asdfg'" value="<?php echo e($estimate->id); ?>" name="invoice_id" ng-model="invoice_id">
                            ...
                            <div class="uk-margin-top">
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Customer" id="customer_id" name="customer_id" required>
                                            ...
                                            <?php $__currentLoopData = $customer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <option <?php echo e($value->id==$estimate->customer_id? "selected":''); ?> value="<?php echo e($value->id); ?>"><?php echo e($value->display_name); ?></option>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="estimate_number"  name="estimate_number" readonly  value="<?php echo e($estimate->estimate_number); ?>" />
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" id="date" type="text"  name="date" value="<?php echo e(date("d-m-Y",strtotime($estimate->date))); ?>" data-uk-datepicker="{format:'DD-MM-YYYY'}" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="reference" name="ref" value="<?php echo e($estimate->ref); ?>" />
                                    </div>
                                </div>
                                    ...
                                    <div class="uk-width-medium-1-2">
                                        <div class="uk-grid" data-uk-grid-margin>
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                ...
                                                <input class="md-input" type="text" id="attn"  name="attn" value="<?php echo e($estimate->attn); ?>"  />
                                    ...
                                    <div class="uk-width-medium-1-2">
                                        ...
                                        <div class="uk-grid" data-uk-grid-margin>
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                ...
                                                <input class="md-input" type="text" id="attn_designation"  name="attn_designation"  value="<?php echo e($estimate->attn_designation); ?>" />
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-3">
                                        ...
                                        <input class="md-input" type="text" id="subject" name="subject" value="<?php echo e($estimate->subject); ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-3">
                                        ...
                                        <textarea  id="editor1" name="heading" rows="12" cols="100"><?php echo $estimate->heading; ?> </textarea>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-3">
                                        ...
                                        <input class="md-input" type="text" id="table_head" name="table_head" value="<?php echo e($estimate->table_head); ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-3">
                                        ...
                                        <textarea  id="editor2" name="terms_conditions" rows="12" cols="100"><?php echo $estimate->terms_conditions; ?>  </textarea>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-3">
                                        ...
                                        <textarea  id="editor3" name="left_notation" rows="12" cols="100"><?php echo $estimate->left_notation; ?></textarea>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-3">
                                        ...
                                        <textarea  id="editor4" name="right_notation" rows="12" cols="100"><?php echo $estimate->right_notation; ?>  </textarea>
