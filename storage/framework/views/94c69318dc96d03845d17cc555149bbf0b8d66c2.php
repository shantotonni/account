                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-margin-top">
                                <?php echo Form::open(['url' => route('order_expense_sector_update', ['id' => $category->id]), 'method' => 'POST']); ?>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="contact_category_name" name="contact_category_name" value="<?php echo e(old('contact_category_name') ? old('contact_category_name') : $category->title); ?>" required/>
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        ...
                                        <textarea class="md-input" name="contact_category_description" id="contact_category_description" cols="30" rows="4" ><?php echo e(old('contact_category_description') ? old('contact_category_description') : $category->summary); ?></textarea>
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        <label for="contact_category_description"> <?php echo e($category->createdBy->name); ?> </label>
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        <label for="contact_category_description"><?php echo e($category->updatedBy->name); ?></label>
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        <label for="contact_category_description"><?php echo e($category->created_at); ?></label>
                                ...
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-width-medium-4-5">
                                        <label for="contact_category_description"><?php echo e($category->updated_at); ?>  </label>
