...
বুধবার','বৃহস্পতিবার','শুক্রবার'
        ...
        <div class="content">
            <p style="font-size: 20px">নিম্নলিখিত, <?php echo $basis[0]->country_name; ?> গামী ইচ্ছুক যাত্রীদের স্বাস্থ্যগত পরীক্ষা নিশ্চিত করার লক্ষ্যে আপনার দপ্তর থেকে প্রয়োজনীয় মেডিকেল স্লিপ প্রদান এর জন্য বিনীত অনুরোধ করছি ।
            </p>
        </div>
        ...
        <table class="table table-bordered">
            ...
            <?php $__currentLoopData = $basis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <tr>
                    ...
                    <td style="font-size: 17px"><?php echo $value->passengerNameBN; ?></td>
                    <td style="font-size: 17px"><?php echo $value->passportNumberBN; ?></td>
                </tr>
       ...
       <h4><?php echo $formbasis->companyNameBN; ?></h4>
