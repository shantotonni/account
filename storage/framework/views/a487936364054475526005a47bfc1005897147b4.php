<?php $__env->startSection('title', 'Police Clearance Edit'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10" ng-controller="ContactEditController">
            <?php echo Form::open(['url' => array('contact/update', 1), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']); ?>
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-large-10-10">
                                    <div class="uk-width-1-1 ">
                                        ...
                                        <a href=" <?php echo URL::previous(); ?>   " type="button" class="md-btn md-btn-flat uk-modal-close">Close</a>
                                    </div>
                                </div>
                            </div>
