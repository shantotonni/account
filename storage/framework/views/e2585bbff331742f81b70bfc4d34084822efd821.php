...
<?php $__env->startSection('angular'); ?>
    <script src="<?php echo e(url('app/moneyin/invoice/paymentReceive.controller.js')); ?>"></script>
<?php $__env->stopSection(); ?>
            ...
            <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="md-card">
                            <?php echo Form::open(['url' => route('payment_received_store'), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data"]); ?>
                                    ...
                                    <div ng-style="{opacity : ((currentPage == 0) && '0.2') || '1'}">
                                        ...
                                        <div class="uk-grid disabled" data-uk-grid-margin id="disabled">
                                            ...
                                            <div class="uk-width-medium-2-5">
                                                ...
                                                <input class="md-input" type="text" id="payment_date" name="payment_date" value="<?php echo e(date('d-m-Y')); ?>"  data-uk-datepicker="{format:'DD-MM-YYYY'}" />
                                            </div>
