<?php $__env->startSection('title', 'MedicalSlip'); ?>
                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                                    ...
                                    <?php $__currentLoopData = $medical; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                           ...
                                           <td class="uk-text-center">
                                                ...
                                                <a onclick="deleterow(this); return false" href="<?php echo route('medicalslip_delete',$value->id); ?>" class=""><i class="md-icon material-icons">&#xE872;</i></a>
                                            </td>
                                        </tr>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="<?php echo route('medicalslip_create'); ?>" class="md-fab md-fab-accent branch-create">
