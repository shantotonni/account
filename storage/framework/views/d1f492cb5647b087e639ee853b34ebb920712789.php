<?php $__env->startSection('title', 'Medical Certificate'); ?>
                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">Medical Certificate List</span></h2>
                                </div>
                            </div>
                                ...
                                <div class="uk-overflow-container uk-margin-bottom">
                                    ...
                                    <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                        ...
                                        <tr>
                                            ...
                                            <th>Medical Certificate Date</th>
                                        ...
                                        <?php $__currentLoopData = $police; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    ...
                                                    <a href="<?php echo e(route('Umrah_Medical_Certificate_edit',$value->id)); ?>"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $('#Umrah_Medicale_Certificate').addClass('act_item');
    </script>
<?php $__env->stopSection(); ?>
