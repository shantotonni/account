<?php $__env->startSection('title', 'Pending Ticket Order'); ?>
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        <?php echo Form::open(['url' => 'ticket/order/pending', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']); ?>
                                    ...
                                    <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="uk-text-center">
                                                <a href="<?php echo e(route('ticket_Order_pendingUpdate',['id' => $value->id])); ?>"><i title="pending" class="md-icon material-icons">&#xE88E;</i></a>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        $('#sidebar_ticket_order_pending').addClass('act_item');
