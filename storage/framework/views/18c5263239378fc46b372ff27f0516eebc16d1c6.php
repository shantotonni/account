<?php $__env->startSection('title', 'Archive Order List'); ?>
                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content">
                                ...
                                <a href="<?php echo route('order'); ?>" class="heading_b pull-right btn btn-success"><span class="uk-text-truncate">Back To Order</span></a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="uk-text-center">
                                               ...
                                               <a href="<?php echo e(route('order_edit', ['id' => $value->id])); ?>">
                                                ...
                                                <a href="<?php echo route('order_archive_back',$value->id); ?>"><i  title="Archive" class="material-icons">&#xE149;</i></a>
