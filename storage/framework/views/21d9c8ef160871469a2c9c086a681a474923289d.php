                    ...
                    <div class="md-card">
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        <?php echo Form::open(['url' => 'expense', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']); ?>
                        ...
                        <div class="user_content">
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($expense->account->account_name); ?></td>
                                            <td><?php echo $expense->save?"<b style='color:#7cb342;'>Draft</b>":"Open"; ?></td>
                                            ...
                                            <td><?php echo e($expense->amount); ?></td>
                                             <td>
                                                <a href="<?php echo e(route('expense_show', ['id' => $expense->id])); ?>">
                                                    <i data-uk-tooltip="{pos:'top'}" title="View" class="md-icon material-icons">visibility</i>
                                                </a>
                                                <a href="<?php echo e(route('expense_edit', ['id' => $expense->id])); ?>">
                                                    <i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i>
                                                </a>
                                                 <a class="delete_btn"><i data-uk-tooltip="{pos:'top'}" title="Delete" class="md-icon material-icons">&#xE872;</i></a>
                                                 <input type="hidden" class="expense_id" value="<?php echo e($expense->id); ?>">
                                                 <a href="<?php echo route('expence_send_view',$expense->id); ?>"><i class="material-icons">&#xE0BE;</i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                    </tbody>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="<?php echo e(route('expense_create')); ?>" class="md-fab md-fab-accent branch-create">
