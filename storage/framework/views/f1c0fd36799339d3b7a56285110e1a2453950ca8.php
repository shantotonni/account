            ...
            <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="md-card">
                            <?php echo Form::open(['url' => route('manpower_service_store'), 'method' => 'POST']); ?>
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="contact_number"  name="phone" value="<?php echo e(old('contact_number')); ?> " />
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="sector"  name="sector" value="<?php echo e(old('sector')); ?> " />
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="returnflightarrivalDate" name="issue_date" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="<?php echo e(old('delivery_date')); ?>" />
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="returnflightarrivalDate" name="delivery_date" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="<?php echo e(old('delivery_date')); ?>" />
                                        </div>
                                    </div>
