                ...
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <?php echo Form::open(['url' => route('credit_note_update', ['id' => $credit_note->id]), 'method' => 'POST', 'id' => 'my_profile','files' => 'true', 'enctype' => "multipart/form-data"]); ?>

                            <input type="hidden" id="credit_note_id" name="credit_note_id" value="<?php echo e($credit_note->id); ?>">
                            <div class="uk-margin-top">
                                    ...
                                    <div class="uk-width-medium-2-5 parsley-row">
                                        <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Customer" id="customer_id" name="customer_id" required>
                                            ...
                                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <?php if($customer->id == $credit_note->customer_id): ?>
                                                    <option value="<?php echo e($customer->id); ?>" selected><?php echo e($customer->display_name); ?></option>
                                                <?php else: ?>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5 parsley-row">
                                        <label for="credit_note_number">CN-<?php echo e($credit_note_number); ?></label>
                                        <input type="hidden" id="credit_note_number" name="credit_note_number" value="<?php echo e($credit_note_number); ?>">
                                    </div>
                                </div>
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5  uk-vertical-align">
                                    ...
                                    <div class="uk-width-medium-2-5 parsley-row">
                                        ...
                                        <input class="md-input" type="text" id="reference" name="reference" value="<?php echo e($credit_note->reference); ?>" required/>
                                    </div>
                                </div>
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5  uk-vertical-align">
                                    ...
                                    <div class="uk-width-medium-2-5 parsley-row">
                                        ...
                                        <input class="md-input" type="text" id="credit_note_date" name="credit_note_date" value="<?php echo e(date("d-m-Y",strtotime($credit_note->credit_note_date))); ?>"  data-uk-datepicker="{format:'DD-MM-YYYY'}" required>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid uk-block" data-uk-grid-margin>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-1">
                                            ...
                                            <?php if($credit_note->file_url): ?>
                                                <a download href="<?php echo e(url($credit_note->file_url)); ?>" >download attachement</a>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="uk-width-medium-1-1">
                                        <div class="uk-width-medium-1-1 uk-margin-bottom">
                                            ...
                                            <textarea class="md-input selecize_init" rows="3" name="customer_note" id="customer_note"><?php echo e($credit_note->customer_note); ?></textarea>
                                            <span class="md-input-bar "></span>
                                        </div>
                                        <div class="uk-width-medium-1-1 uk-margin-bottom">
                                            <label for="terms_and_condition">Terms &amp; Conditions</label>
                                            <textarea class="md-input selecize_init" rows="3" name="terms_and_condition" id="terms_and_condition"><?php echo e($credit_note->terms_and_condition); ?></textarea>
                                            <span class="md-input-bar "></span>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->startSection('angular'); ?>
    <script src="<?php echo e(url('app/creditnote/creditnote_edit.controller.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
