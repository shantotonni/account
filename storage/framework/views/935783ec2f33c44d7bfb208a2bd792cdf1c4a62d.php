                ...
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <?php echo Form::open(['url' => route('credit_note_store'), 'method' => 'POST', 'id' => 'my_profile','files' => 'true', 'enctype' => "multipart/form-data"]); ?>
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5 parsley-row">
                                            ...
                                            <input class="md-input" type="text" id="credit_note_date" name="credit_note_date"  value="<?php echo e(Carbon\Carbon::now()->format('d-m-Y')); ?>" data-uk-datepicker="{format:'DD.MM.YYYY'}" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="uk-width-medium-1-1">
                                            <table class="uk-table">
                                                ...
                                                <tr ng-repeat="credit_notes in credit_notes track by $index" class="form_section">
                                                    ...
                                                    <td>
                                                        <input type="text" id="description_{{ $index + 1 }}" class="md-input" name="description[]" ng-model="description">
                                                    </td>
                                                    <td>
                                                        <input type="text"
...
<?php $__env->startSection('angular'); ?>
    <script src="<?php echo e(url('app/creditnote/creditnote.controller.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
