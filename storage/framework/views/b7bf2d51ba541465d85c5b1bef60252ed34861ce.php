...
<div class="" role="main">
    ...
    <div class="app">
        <div class="flex-container">
            ...
            <div style="width: 50%; left: 50px;float: left;text-align: center;padding-left: 150px"> <img height="80" width="80" src="<?php echo e(asset('img/embassy.png')); ?>" /></div>
        ...
        <div style="padding-top: 10px">
            <div style="font-size: 12px;width: 70%">Full Name: <span style="text-transform: uppercase;font-weight: bold">
                    <?php echo isset($data['recruit_order']['passenger_name']) ? $data['recruit_order']['passenger_name']:''; ?>, S/O <?php echo $data['visaform']['so']; ?></span>
            </div>
...
:                   اسم الكامل
        ...
        <div style="padding-top: 5px;padding-bottom: 5px">
            <div style="font-size: 12px;width: 70%">Mother`s Name:	<span style="font-weight: bold"><?php echo isset($data['recruit_customer']['motherName'])?$data['recruit_customer']['motherName']:''; ?></span> </div>
            <div style="float: right;text-align: right;width: 30%;padding-top: -20px">
                <span style="text-transform: uppercase; font-weight: bold; font-size: 12px; text-align: right;">
            :        اسم الام
                </span>
        ...
        <div style="padding-top: 5px;padding-bottom: 5px">
            <div style="font-size: 12px;width: 20%;float: left">Date Of Birth: <span style="font-weight: bold"><?php echo isset($data['recruit_customer']['dateOfBirthEN'])?$data['recruit_customer']['dateOfBirthEN']:''; ?></span></div>
            <div style="font-size: 12px;width: 30%;float: left; font-weight: bold"> : تاريخ الولادة
            </div>
            <div style="font-size: 12px;width: 30%;float: left">Place Of Birth: <span style="font-weight: bold"><?php echo isset($data['recruit_customer']['placeOfBirth'])?$data['recruit_customer']['placeOfBirth']:''; ?> </span></div>
        ...
        <div style="padding-top: 5px;padding-bottom: 5px">
            <div style="font-size: 12px;width: 30%;float: left">Previous Nationality: <span style="font-weight: bold"><?php echo isset($data['recruit_customer']['previousNationality'])?$data['recruit_customer']['previousNationality']:''; ?></span></div>
            <div style="font-size: 12px;width: 20%;float: left; font-weight: bold"> :الجنسية السابقة
            </div>
            <div style="font-size: 12px;width: 30%;float: left">Present Nationality: <span style="font-weight: bold"><?php echo isset($data['recruit_customer']['presentNationality'])?$data['recruit_customer']['presentNationality']:''; ?> </span></div>
            <div style="float: right;text-align: right;width: 20%;">
                <span style="text-transform: uppercase; font-weight: bold; font-size: 12px; text-align: right;">
            : الجسية الحا لية
                </span>
        ...
        <div style="padding-top: 5px;padding-bottom: 5px">
            <div style="font-size: 12px;width: 20%;float: left;border-radius: 100%">Sex: <span style="font-weight: bold">Female</span>
                <?php if(isset($data['recruit_customer']['gender'])): ?>
                <?php if(strtoupper(substr($data['recruit_customer']['gender'],0,2))=="FE"): ?>
                    ✔
                <?php endif; ?>
                <?php endif; ?>
                انثي</div>
            <div style="font-size: 12px;width: 15%;float: left"> <span style="font-weight: bold">Male</span>
                <?php if(isset($data['recruit_customer']['gender'])): ?>
                <?php if(strtoupper(substr($data['recruit_customer']['gender'],0,2))=="MA"): ?>
                    ✔
                <?php endif; ?>
                <?php endif; ?>
                زكر</div>

            <div style="font-size: 12px;width: 30%;float: left">Marital Status: <span style="text-transform: uppercase;font-weight: bold"><?php echo isset($data['recruit_customer']['maritalStatus'])?$data['recruit_customer']['maritalStatus']:''; ?> </span></div>
            <div style="float: right;text-align: right;width: 20%;">
                <span style="text-transform: uppercase; font-weight: bold; font-size: 12px; text-align: right;">
            : الحا لية الجتما عية
                </span>
        ...
        <div style="padding-top: 5px;padding-bottom: 5px">
            <div style="font-size: 12px;width: 30%;float: left">Sect: <span style="font-weight: bold"><?php echo isset($data['visaentry']['iqamaSector'])?$data['visaentry']['iqamaSector']:''; ?></span></div>
            <div style="font-size: 12px;width: 20%;float: left; font-weight: bold"> :المذهب
            </div>
            <div style="font-size: 12px;width: 30%;float: left">Religion: <span style="font-weight: bold"><?php echo isset($data['recruit_customer']['religionEN'])?$data['recruit_customer']['religionEN']:''; ?></span> </div>
            <div style="float: right;text-align: right;width: 20%;">
                <span style="text-transform: uppercase; font-weight: bold; font-size: 12px; text-align: right;">
            : الديانة
                </span>
        ...
        <div style="padding-top: 2px">
            ...
            :<?php echo isset($data['recruit_customer']['professionAR'])?$data['recruit_customer']['professionAR']:''; ?>
        ...
        <div>
            ...
            <div style="font-size: 12px;width: 30%;float: left;"> Qualification: <span style="font-weight: bold"><?php echo isset($data['recruit_customer']['qualification'])?$data['recruit_customer']['qualification']:''; ?></span> </div>
            <div style="font-size: 12px;width: 20%;float: left">Profession </div>
            <div style="float: right;text-align: right;width: 30%;">
                <span style="font-size: 12px; text-align: right;font-weight: bold">
                   <?php echo isset($data['recruit_customer']['professionEn'])?$data['recruit_customer']['professionEn']:''; ?>
        ...
        <div style="padding-top: 5px;padding-bottom: 5px">
            <div style="font-size: 12px;width: 70%">Home address and telephone No: <span style="font-weight: bold"><?php echo isset($data['recruit_customer']['addressEN'])?$data['recruit_customer']['addressEN']:''; ?> </span> </div>
            <div style="float: right;text-align: right;width: 30%;padding-top: -20px">
                <span style="text-transform: uppercase; font-weight: bold; font-size: 12px; text-align: right;">
:                   عنوان المنزل و رقم التافون
        ...
        <div style="padding-top: 5px;padding-bottom: 5px">
            <div style="font-size: 12px;width: 70%">Business address and telephone No: <span style="font-weight: bold"><?php echo isset($data['recruit_customer']['businessAddressEN'])?$data['recruit_customer']['businessAddressEN']:''; ?></span> </div>
            <div style="float: right;text-align: right;width: 30%;padding-top: -20px">
                <span style="text-transform: uppercase; font-weight: bold; font-size: 12px; text-align: right;">
:                 عنوان الشركة(الموسسة)و رقم التلفون
        ...
        <div style="padding-top: 3px;padding-bottom: 3px;">
            ...
            <div style="font-size: 10px;width: 8%;float: left;border: 1px solid black;text-align: center;height: 30px;margin-left: 8px"> عمل<br> work
                <?php if(isset($data['recruit_customer']['purposeOfTravel'])): ?>
                    <?php if(strtoupper(substr($data['recruit_customer']['purposeOfTravel'],0,2))=="WO"): ?>
                        ✔
                    <?php endif; ?>
                <?php endif; ?>
                </div>
            <div style="font-size: 10px;width: 8%;float: left;border: 1px solid black;text-align: center;height: 30px;margin-left: 8px"> مرور <br>Transit
                <?php if(isset($data['recruit_customer']['purposeOfTravel'])): ?>
                    <?php if(strtoupper(substr($data['recruit_customer']['purposeOfTravel'],0,2))=="TR"): ?>
                        ✔
                    <?php endif; ?>
                <?php endif; ?>
            </div>
            <div style="font-size: 10px;width: 8%;float: left;border: 1px solid black;text-align: center;height: 30px;margin-left: 8px"> زيارة <br>Visit
                <?php if(isset($data['recruit_customer']['purposeOfTravel'])): ?>
                    <?php if(strtoupper(substr($data['recruit_customer']['purposeOfTravel'],0,2))=="VI"): ?>
                        ✔
                    <?php endif; ?>
                <?php endif; ?>
            </div>
            <div style="font-size: 10px;width: 8%;float: left;border: 1px solid black;text-align: center;height: 30px;margin-left: 8px"> عمرة<br>Umrah
                <?php if(isset($data['recruit_customer']['purposeOfTravel'])): ?>
                    <?php if(strtoupper(substr($data['recruit_customer']['purposeOfTravel'],0,2))=="UM"): ?>
                        ✔
                    <?php endif; ?>
                <?php endif; ?>
            </div>
            <div style="font-size: 10px;width: 8%;float: left;border: 1px solid black;text-align: center;height: 30px;margin-left: 8px"> للاقامة <br>Residence
                <?php if(isset($data['recruit_customer']['purposeOfTravel'])): ?>
                    <?php if(strtoupper(substr($data['recruit_customer']['purposeOfTravel'],0,2))=="RE"): ?>
                        ✔
                    <?php endif; ?>
                <?php endif; ?>
            </div>
            <div style="font-size: 10px;width: 8%;float: left;border: 1px solid black;text-align: center;height: 30px;margin-left: 8px"> حج <br>Hajj
                <?php if(isset($data['recruit_customer']['purposeOfTravel'])): ?>
                    <?php if(strtoupper(substr($data['recruit_customer']['purposeOfTravel'],0,2))=="HA"): ?>
                        ✔
                    <?php endif; ?>
                <?php endif; ?>
            </div>
            <div style="font-size: 10px;width: 10%;float: left;border: 1px solid black;text-align: center;height: 30px;margin-left: 8px"> دبلوماسيت  <br>Diplomacy
                <?php if(isset($data['recruit_customer']['purposeOfTravel'])): ?>
                    <?php if(strtoupper(substr($data['recruit_customer']['purposeOfTravel'],0,2))=="DI"): ?>
                        ✔
                    <?php endif; ?>
                <?php endif; ?>
            </div>
     ...
     :     رقم الجواز
        ...
        <div>
            <div style="font-size: 12px;width: 30%;float: left">Place of Issue: <span style="font-weight: bold"><?php echo isset($data['recruit_order']['placeofissue'])?$data['recruit_order']['placeofissue']:''; ?></span> </div>
            <div style="font-size: 12px;width: 40%;float: left;">Date of  Passport issued: <span style="font-weight: bold"><?php echo isset($data['recruit_order']['passportissuedate'])?$data['recruit_order']['passportissuedate']:''; ?></span> </div>
            <div style="font-size: 12px;width: 30%;float: left">Passport No: <span style="font-weight: bold"><?php echo isset($data['recruit_order']['passportNumber'])?$data['recruit_order']['passportNumber']:''; ?></span> </div>
        </div>
        <div style="padding-top: 2px">
            <div style="font-size: 12px;width: 60%;float: left"> Date of Passport`s expiry: <span style="font-weight: bold">  <?php echo isset($data['recruit_order']['passportissuedate']) ? date('Y-m-d',strtotime($data['recruit_order']['passportissuedate'].'+5 years')-('+1 day')):''; ?> </span> </div>
            <div style="float: right;text-align: right;width: 30%;">
                <span style="text-transform: uppercase; font-weight: bold; font-size: 12px; text-align: right;">
 ...
 ايصال رقم ()</div>
     ...
     :  اسم المحرم
        ...
        <div style="padding-top: 5px;padding-bottom: 5px">
            ...
            <div style="font-size: 12px;width: 20%;float: left;">Carrier`s Name: <span style="font-weight: bold"><?php echo isset($data['flight']['carrierName'])?$data['flight']['carrierName']:''; ?></span></div>
            <div style="float: right;text-align: right;width: 30%;">
                <span style="text-transform: uppercase; font-size: 12px; text-align: right;">
     : اسم الشركة الناقلة
                </span>
     ...
     : ايضاحات تخص افراد(المضافين) علي نفس جواز السفر
        ...
        <table border="1" width="100%" style="border: .5px solid #002b36">
            ...
            <tbody>
            <?php $__currentLoopData = $data['visaform']['formBulk']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            <tr>
                <td style="text-align: center"><?php echo e($item->relationship); ?></td>
                <td style="text-align: center"><?php echo e($item->dateofBirth); ?></td>
                <td style="text-align: center"><?php echo e($item->gender); ?></td>
     ...
     : اسم وعنوان الشركة أو اسم الشخص وعنوانة بالمملكة
        ...
        <div style="padding-top: 5px;padding-bottom: 5px">
            <div style="font-size: 12px;width: 100%;float: left;text-transform: uppercase"> <span style="font-weight: bold"><?php echo isset($data['Company']['name'])?$data['Company']['name']:''; ?> ,<?php echo isset($data['Company']['companyAddress'])?$data['Company']['companyAddress']:''; ?></span></div>
        </div>
    ...
    وساكون سلتز سابقو انين الممكت اثناء فتر و جودي بها
        ...
        <div>
            ...
            <div style="font-size: 12px;width: 30%;float: left">Name: <span style="font-weight: bold"><?php echo isset($data['recruit_order']['passenger_name']) ? $data['recruit_order']['passenger_name']:''; ?></span></div>
