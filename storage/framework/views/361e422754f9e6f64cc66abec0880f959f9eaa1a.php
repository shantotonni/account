                    ...
                    <div class="md-card">
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        <?php echo Form::open(['url' => 'bank', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']); ?>
                        ...
                        <div class="user_content">
                            <div class="uk-overflow-container uk-margin-bottom">
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            <td><?php echo e($i++); ?></td>
                                            <td><?php echo e(date('d-m-Y', strtotime($bank->date))); ?></td>
                                            <td><?php echo e($bank->contact->display_name); ?></td>
                                            <td><?php echo e($bank->type); ?></td>
                                            <td><?php echo e($bank->account->account_name); ?></td>
                                            <td><?php echo e($bank->account->account_name); ?></td>
                                            <td><?php echo e($bank->total_amount); ?></td>
                                            <td class="uk-text-center">
                                                <a href="<?php echo e(route('bank_show', ['id' => $bank->id])); ?>"><i data-uk-tooltip="{pos:'top'}" title="View" class="md-icon material-icons">visibility</i></a>
                                                <a href="<?php echo e(route('bank_edit', ['id' => $bank->id])); ?>"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
                                                <a class="delete_btn"><i data-uk-tooltip="{pos:'top'}" title="Delete" class="md-icon material-icons">&#xE872;</i></a>
                                                <input type="hidden" class="bank_id" value="<?php echo e($bank->id); ?>">
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                    </tbody>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="<?php echo e(route('bank_create')); ?>" class="md-fab md-fab-accent branch-create">
