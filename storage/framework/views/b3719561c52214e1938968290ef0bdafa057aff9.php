                                                            ...
                                                            <div class="uk-grid" data-uk-grid-margin>
                                                                <div class="uk-width-medium-1-1">
                                                                    <select required id="select_demo_1" class="md-input data" onchange="myFunction()" name="registerSerial_id[]">
                                                                        ...
                                                                        <?php $__currentLoopData = $arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                            <?php if($value[0]['totalserial']>0): ?>
                                                                            <option value="<?php echo $value[0]['id']; ?>/<?php echo $value[0]['totalserial']; ?>"><?php echo $value[0]['registerSerial']; ?></option>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                                    </select>
