...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('admin/assets/js/pages/forms_advanced.js')); ?>" media="all">
...
<!-- uikit functions -->
<script src="<?php echo e(url('admin/assets/js/uikit_custom.js')); ?>"></script>
