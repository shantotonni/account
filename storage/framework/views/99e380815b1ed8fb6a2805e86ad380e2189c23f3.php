<?php $__env->startSection('title', 'Manpower Service Hotel Create'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            <?php endif; ?>
            <?php echo Form::open(['url' => route('manpower_service_hotel_store'), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']); ?>
                            ...
                            <div class="user_heading_content">
                                ...
                                <div class="uk-width-medium-1-3">
                                    <div class="md-btn-group">
                                        <a href="<?php echo e(route('manpower_service_hotel_index')); ?>" class="md-btn md-btn-small md-btn-primary md-btn-wave">All</a>
                                        <a href="<?php echo e(route('manpower_service_hotel_create')); ?>" class="md-btn md-btn-small md-btn-primary md-btn-wave">Add</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <?php if($errors->has('title')): ?>
                                             <br/>
                                            <span style="color:orangered;"><?php echo $errors->first('title'); ?></span>
