                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <div class="uk-overflow-container uk-margin-bottom">
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                   ...
                                   ?>
                                    ...
                                    <tbody>
                                    <?php $__currentLoopData = $finger; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <tr>
                                                <td><?php echo $i++; ?></td>
                                                ...
                                                <td class="uk-text-center">
                                                    ...
                                                    <input type="hidden" class="fingerprint_id" value="<?php echo e($value->id); ?>">
                                                </td>
                                            </tr>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="<?php echo route('fingerprint_create'); ?>" class="md-fab md-fab-accent branch-create">
