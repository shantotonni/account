            ...
            <div class="uk-navbar-flip">
                <ul class="uk-navbar-nav user_actions">
                    ...
                    <li data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                        ...
                        <?php if(Auth::user()->image == 'user.jpg'): ?>
                        <img class="md-user-image" src="<?php echo e(url('admin/assets/img/avatars/user-2.png')); ?>">
                        <?php else: ?>
                        <img class="md-user-image" src="<?php echo e(url('uploads/users/'.Auth::user()->image)); ?>" alt="">
                        <?php endif; ?>
                        </a>
                        <div class="uk-dropdown uk-dropdown-small">
                            <ul class="uk-nav js-uk-prevent">
                                <ul class="uk-nav js-uk-prevent">
                                    <li><a href="<?php echo e(url('settings/my-profile')); ?>">My profile</a></li>
                                    <li><a href="<?php echo e(route('organization_profile')); ?>">Settings</a></li>
    ...
    <div class="scrollbar-inner">
        <ul id="dashboard_sidebar_tabs" class="uk-switcher">
            <li>
                ...
                <?php $Dashboard = app('App\Lib\Deshboard'); ?>
                <div class="timeline timeline_small uk-margin-bottom" id="reminder-1">
                    <?php $__currentLoopData = $Dashboard->Reminder(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
    ...
    <div class="uk-modal-dialog">
        ...
        <div class="uk-width-medium-1-2">
            ...
            <div class="uk-form-row">
                ...
                <input class="md-input" type="text" id="date" value="<?php echo e(date('Y-m-d')); ?>" data-uk-datepicker="{format:'YYYY-MM-DD'}">
            </div>
...
<script>
    ...
    {
        axios.get('<?php echo e(route('dashboard_todayreminder')); ?>', {
    ...
    function AddReminder()
    {
       ...
       var reminderaddfail = document.getElementById('reminderaddfail');
        ...
        axios.post('<?php echo e(route('dashboard_reminder')); ?>', {
            note: note,
            time: time,
            date: date,
               })
