                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i++; ?></td>
                                <td><?php echo $recruit->finger['date']; ?></td>
                                <td><?php echo $recruit->paxid; ?></td>
                                <td><?php echo $recruit->finger['number']; ?></td>
                                <?php if($recruit->finger['bmet_status'] === 0): ?>
                                    <td><font color="red" >Not ok</font></td>
                                <?php elseif($recruit->finger['bmet_status'] === 1): ?>
                                    <td><font color="green" >Ok</font></td>
                                <?php else: ?>
                                    <td></td>
                                <?php endif; ?>

                                <?php if($recruit->id==$recruit->finger['pax_id']): ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('fingerprint_edit',$recruit->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                    </td>
                                <?php else: ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('fingerprint_create',$recruit->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">+</i></a>
                                    </td>
                                <?php endif; ?>
