...
<div>
    <div id="testdiv">
        <div class="flex-container" style=" padding: 20px 0px; line-height:3px;">
            <div style="width:30%;padding-left: 95px"><img width="50%" src="<?php echo asset('uploads/op-logo/'); ?>/<?php echo isset($organ->logo)?$organ->logo:''; ?>" /></div>
            <div style="width:70%;text-align:center; float: left; margin-left: 150px; margin-top: -70px;">
                <h1 style="font-size:30px;"> <?php echo $form->companyNameEN; ?> </h1> <p style="font-size:14px;"> (Govt. Approved Recruiting Agent ,<?php echo $form->licenceEN; ?>) </p>
            </div>
        ...
        <div class="flex-container padding">
            ...
            <div class="flex-item-3" > : <?php echo e($name->nameAr); ?></div>

        </div>

        <div class="flex-container padding">
            <div class="flex-item-2">2. visa no. & date  </div>
            <div class="flex-item-3"> : <span style="text-align: left; padding:0px 50px; font-weight:bold"> <?php echo e($visanumber->visaNumber); ?> </span>&nbsp;&nbsp;&nbsp; Date. <?php echo e($visanumber->visaIssuedate); ?> </div>

        </div>
        <div class="flex-container padding">
            <div class="flex-item-2">3. full name of the employee  </div>
            <div class="flex-item-3"> : <span style="text-align: left; padding:0px 20px; font-weight:bold"> <?php echo e(strtoupper($contact)); ?> </span> </div>

        </div>

        <div class="flex-container padding">
            <div class="flex-item-2">4. passport no. and issue date  </div>
            <div class="flex-item-3"> : <span style="text-align: left; padding:0px 50px; font-weight:bold"> <?php echo e($recruit->passportNumber); ?> </span>&nbsp;&nbsp;&nbsp; dt. <?php echo e($recruit->passportDate); ?> </div>

        </div>
        <div class="flex-container padding">
            <div class="flex-item-2">5. Profession  </div>
            <div class="flex-item-3"> : <span style="text-align: left; padding:0px 20px; font-weight:bold"> <?php echo e(strtoupper($customer->professionAR)); ?> </span>  </div>

        </div>
        <div class="flex-container padding">
            <div class="flex-item-2">6. Religion  </div>
            <div class="flex-item-3"> : <span style="text-align: left; padding:0px 20px; font-weight:bold"> <?php echo e(strtoupper($customer->religionEN)); ?> </span>  </div>
