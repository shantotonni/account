<?php $__env->startSection('title', 'Confirmation Bill'); ?>
                ...
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <?php echo Form::open(['url' => route('confirmation_bill_store' , $id ), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']); ?>
