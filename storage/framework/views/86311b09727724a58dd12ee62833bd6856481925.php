                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid " data-uk-grid-margin style="visibility: visible">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <select data-md-selectize data-uk-tooltip="{pos:'top'}" title="Select Customer" class="order_image" id="local_ref" onchange="orderimage()" name="order_status">
                                                ...
                                                <option <?php echo e(($order->order_status==1)?"selected":''); ?> value="1" >Completed</option>
                                                <option <?php echo e(($order->order_status==2)?"selected":''); ?> value="2" >Cancelled</option>
                                            </select>
                                            <?php if($errors->has('customer_id')): ?>
                                                <div class="uk-text-danger"><?php echo e($errors->first('customer_id')); ?></div>
                                            <?php endif; ?>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="order_pax">Pax : <?php echo e($order->paxid); ?></label>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="passportNumber" oninput="input()"  name="passportNumber" value="<?php echo e($order->passportNumber); ?> " />
...
<script>
    ...
    function load() {
        var cancal = "<?php echo e($order->order_status); ?>";
