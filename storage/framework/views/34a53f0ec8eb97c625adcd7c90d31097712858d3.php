<?php $__env->startSection('title', 'Customer Stamping'); ?>
                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo $i++; ?></td>
                                <td><?php echo $recruit->visas['send_date']; ?></td>
                                <td><?php echo $recruit->visas['return_date']; ?></td>
                                <td><?php echo $recruit->paxid; ?></td>
                                <td><?php echo $recruit->visas['comment']; ?></td>

                                <?php if($recruit->id==$recruit->visas['pax_id']): ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('visastamp_edit',$recruit->visas['id']); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                    </td>
                                <?php else: ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('visastamp_create',$recruit->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">+</i></a>
                                    </td>
                                <?php endif; ?>
