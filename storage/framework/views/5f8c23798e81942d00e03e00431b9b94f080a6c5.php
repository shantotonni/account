                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i++; ?></td>
                                <td><?php echo $recruit->completion['date']; ?></td>
                                <td><?php echo $recruit->paxid; ?></td>
                                <td><?php echo $recruit->completion['smart_card_number']; ?></td>

                                <?php if($recruit->id==$recruit->completion['paxid']): ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('completion_edit',$recruit->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                    </td>
                                <?php else: ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('completion_create',$recruit->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">+</i></a>
                                    </td>
                                <?php endif; ?>
