...
<?php $__env->startSection('angular'); ?>
    <script src="<?php echo e(url('app/contact/contact/contactEdit.controller.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10" ng-controller="ContactEditController">
            <?php echo Form::open(['url' => array('contact/update', $contact_id), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']); ?>
                    ...
                    <div class="uk-width-large-10-10">
                        <div class="md-card">
                            <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                                ...
                                <input type="hidden" ng-init="contact_id='asdfg'" value="<?php echo e($contact->id); ?>" name="contact_id" ng-model="contact_id">
                                ...
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="first_name" name="first_name" value="<?php echo e($contact->first_name); ?>"  />
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="last_name" name="last_name"  value="<?php echo e($contact->last_name); ?>"  />
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="display_name" name="display_name" value="<?php echo e($contact->display_name); ?>" />
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="company_name" name="company_name" value="<?php echo e($contact->company_name); ?>" />
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="email_address" name="email_address" value="<?php echo e($contact->email_address); ?>" />
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <input class="md-input" type="text" id="skype_name" name="skype_name" value="<?php echo e($contact->skype_name); ?>" />
                                        </div>
                                    </div>
                                    <div class="uk-grid">
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-medium-1-5">
                                            ...
                                            <input class="md-input" type="text" id="phone_number_1" name="phone_number_1" value="<?php echo e($contact->phone_number_1); ?>" required/>
                                        </div>
                                        <div class="uk-width-medium-1-5">
                                            <label for="phone_number_2">Contact Number 2</label>
                                            <input class="md-input" type="text" id="phone_number_2" name="phone_number_2" value="<?php echo e($contact->phone_number_2); ?>" />
                                        </div>
                                        <div class="uk-width-medium-1-5">
                                            <label for="phone_number_3">Contact Number 3</label>
                                            <input class="md-input" type="text" id="phone_number_3" name="phone_number_3" value="<?php echo e($contact->phone_number_3); ?>" />
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                        ...
                                        <div class="uk-width-1-2">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="billing_street" name="billing_street" value="<?php echo e($contact->billing_street); ?>" />
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-4 uk-vertical-align">
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="billing_city" name="billing_city" value="<?php echo e($contact->billing_city); ?>" />
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-4 uk-vertical-align">
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="billing_state" name="billing_state" value="<?php echo e($contact->billing_state); ?>" />
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-4 uk-vertical-align">
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="billing_zip_code" name="billing_zip_code" value="<?php echo e($contact->billing_zip_code); ?>" />
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-4 uk-vertical-align">
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="billing_country" name="billing_country" value="<?php echo e($contact->billing_country); ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="uk-width-1-2">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="shipping_street" name="shipping_street" value="<?php echo e($contact->shipping_street); ?>" />
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-4 uk-vertical-align">
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="shipping_city" name="shipping_city" value="<?php echo e($contact->shipping_city); ?>" />
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-4 uk-vertical-align">
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="shipping_state" name="shipping_state" value="<?php echo e($contact->shipping_state); ?>" />
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-4 uk-vertical-align">
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="shipping_zip_code" name="shipping_zip_code" value="<?php echo e($contact->shipping_zip_code); ?>" />
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-4 uk-vertical-align">
                                                ...
                                                <div class="uk-width-medium-3-4">
                                                    ...
                                                    <input class="md-input" type="text" id="shipping_country" name="shipping_country" value="<?php echo e($contact->shipping_country); ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="uk-grid uk-grid-width-1-1 uk-grid-width-large-1-2" data-uk-grid-margin>
                                                <div>
                                                    <div class="uk-input-group">
                                                        ...
                                                        <input type="text" class="md-input" id="fb_id" name="fb_id" value="<?php echo e($contact->fb_id); ?>" />
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="uk-input-group">
                                                        ...
                                                        <input type="text" class="md-input" id="tw_id" name="tw_id" value="<?php echo e($contact->tw_id); ?>" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-1-1">
                                            ...
                                            <textarea class="md-input" name="about" id="about" cols="30" rows="4"><?php echo e($contact->about); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
