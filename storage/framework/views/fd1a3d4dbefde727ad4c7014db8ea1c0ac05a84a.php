                                ...
                                <div class="md-card">
                                    ...
                                    <div class="user_content">
                                        ...
                                        <div class="uk-margin-top">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-5 uk-vertical-align">
                                                    <label class="uk-vertical-align-middle" for="group">Sub Reference</label>
                                                </div>
                                                <div class="uk-width-medium-2-5">
                                                    <label for="group">Sub Reference</label>
                                                    <input class="md-input" type="text" id="group" name="sub_reference" value="<?php echo e(trim($customer_info->sub_reference,',')); ?>" />
                                                    <br>
                                                    <label for="group">Sub Reference:
                                                        <?php if(empty($customer_info->sub_reference)): ?>
                                                            0
                                                            <?php else: ?>
                                                            <?php echo count(explode(',',$customer_info->sub_reference)); ?>
