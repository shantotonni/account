...
<div class="uk-modal" id="modal_header_footer" ng-controller="UseCreditController">
    <div class="uk-modal-dialog">
        <div class="uk-modal-header">
            <h3 class="uk-modal-title">Use credits for INV-<?php echo e(str_pad($invoice->invoice_number, 6, '0', STR_PAD_LEFT)); ?></h3>Invoice Balance: BDT <?php echo e($helper->getDueBalance($invoice->id)); ?>

        </div>

        <?php echo Form::open(['url' => route('post_use_credit'), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']); ?>
