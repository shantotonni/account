<?php $__env->startSection('title', 'Pending Manpower Service'); ?>
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        <?php echo Form::open(['url' => 'manpower/service/pending', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']); ?>
                                    ...
                                    <?php $__currentLoopData = $manpower; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="uk-text-center">
                                                <a href="<?php echo e(route('manpower_service_pendingUpdate',['id' => $value->id])); ?>"><i title="pending" class="md-icon material-icons">&#xE88E;</i></a>
                                                <a href="<?php echo e(route('manpower_service_pdf',['id' => $value->id])); ?>"><i class="material-icons">&#xE415;</i></a>
                                                <a href="<?php echo e(route('manpower_service_bill_show',['id' => $value->bill_id?$value->bill_id:0,'order'=>$value->id])); ?>"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons <?php echo e($value->bill_id?' md-color-light-green-700': ''); ?>">B</i></a>
                                                <a href="<?php echo e(route('manpower_service_invoice_show',['id' => $value->invoice_id?$value->invoice_id:0,'order'=>$value->id])); ?>"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons <?php echo e($value->invoice_id?' md-color-light-green-700': ''); ?>">I</i></a>
