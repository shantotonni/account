                                    ...
                                    <div class="parsley-row">
                                        <div class="dynamic_radio uk-margin-small-top">
                                                <span class="icheck-inline fit">
                                                     <label for="d_form_gender_m" class="inline-label">
                                                    <input type="radio" class="fit" name="status" value="1" <?php echo $medical->status===1? 'checked':''; ?> id="status" data-md-icheck  />
                                                   Fit</label>
                                                </span>
                                            <span class="icheck-inline" id="unfit">
                                                 <label for="d_form_gender_f" class="inline-label">
                                                <input  type="radio" name="status" value="0" <?php echo $medical->status===0? 'checked':''; ?>  id="statuss" data-md-icheck  />
                                               Unfit</label>
                                             </span>
                                        </div>
                                    </div>
