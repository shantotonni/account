...
<div role="main">
    <div class="app" style="padding-top: 300px;">
        ...
        <div class="content">
            <p>সম্মান প্রদর্শন পূর্বক নিবেদন এই যে ,আমি নিম্ন স্বাক্ষরকারী ,<?php echo $formbasis->ownerNameBN; ?>,<?php echo $formbasis->ownerDesignationBN; ?> <?php echo $formbasis->companyNameBN; ?> (<?php echo $formbasis->licenceBN; ?>) ,(<?php echo $formbasis->addressBN; ?>)।
              উক্ত <?php echo $agreement['0']->gender; ?> তাদের কর্মস্থলে যাবতীয় বিষয়াদি, বেতন, অবস্থান, থাকা, খাওয়া ও সামাজিক নিরাপত্তা সম্পর্কে নিশ্চিত হইয়াছেন । তারপরও আমি এই মর্মে অঙ্গীকার করতেছি যে,<?php echo $agreement['0']->country_name; ?> অবস্থিত <?php echo $agreement['0']->gender; ?> কর্মীর সমস্ত দায় দায়িত্ব আমি বহন করিব।
            </p>
        </div>
        <br>
    </div>
    ...
    <div class="app" style="padding-top: 200px;">
        ...
        <br>
        <br>
        <h2 style="text-align: center;text-decoration: underline"><?php echo $agreement['0']->country_name; ?> গামী সত্যায়িত <?php echo $agreement['0']->gender; ?> কর্মীর তালিকা</h2>
        <br>
        <div class="content">
            <table class="table table-bordered">
                ...
                ?>
                <tbody>
                <?php $__currentLoopData = $agreement2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agree): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>

                <tr>
                    <td style="height: 40px"><?php echo $i++; ?></td>
                    <td><?php echo $agree->passenger_name; ?> </td>
                    <td><?php echo $agree->passportNumber; ?> </td>
                    <td><?php echo $agree->display_name; ?> </td>
