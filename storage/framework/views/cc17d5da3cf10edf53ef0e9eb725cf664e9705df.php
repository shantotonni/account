...
<div class="uk-modal" id="modal_header_footer1" ng-controller="ExcessPaymentController">
    <div class="uk-modal-dialog">
        <div class="uk-modal-header">
            <h3 class="uk-modal-title">Use Excess Payment for BILL-<?php echo e(str_pad($bill->bill_number, 6, '0', STR_PAD_LEFT)); ?></h3>Bill Balance: BDT <?php echo e($helper->getBillDueBalance($bill->id)); ?>

        </div>
        <?php echo Form::open(['url' => route('post_bill_excess_payment'), 'method' => 'post', 'class' => 'uk-form-stacked', 'id' => 'user_edit_form', 'files' => 'true']); ?>
