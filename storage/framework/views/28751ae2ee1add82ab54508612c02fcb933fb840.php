                                ...
                                <div class="uk-width-small-1-2">
                                    ...
                                    <table id="info" class="uk-table inv_top_right_table">
                                     ...
                                     <?php endif; ?>
                                       ...
                                       <?php if(isset($invoice->Recruit)): ?>
                                        <tr style="white-space:nowrap; line-height: 10px;">
                                            <td > Passenger Name</td>
                                            <td style="white-space:nowrap; text-align: center"><?php echo strlen($invoice->Recruit->first_name)>25?$invoice->Recruit->first_name."<br/>":$invoice->Recruit->first_name." "; ?> <?php echo e($invoice->Recruit->last_name); ?> </td>
                                        </tr>

                                        <tr >
                                         <td class="uk-text-left " style="word-wrap: break-word"> Ticket Number</td>
                                         <td class="uk-text-center "><?php echo e($invoice->Recruit->ticket_number); ?></td>
                                        </tr>
                                        <?php else: ?>
                                               <tr>
