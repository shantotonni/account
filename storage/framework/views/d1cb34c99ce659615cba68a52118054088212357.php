                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="display_name" name="display_name" value="<?php echo e(isset ($op->display_name)?$op->display_name:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="company_name" name="company_name" value="<?php echo e(isset($op->company_name)?$op->company_name:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="street" name="street" value="<?php echo e(isset($op->street)?$op->street:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="city" name="city" value="<?php echo e(isset($op->city)?$op->city:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="state" name="state" value="<?php echo e(isset($op->state)?$op->state:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="country" name="country" value="<?php echo e(isset($op->country)?$op->country:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="zip_code" name="zip_code" value="<?php echo e(isset($op->zip_code)?$op->zip_code:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="website" name="website" value="<?php echo e(isset($op->website)?$op->website:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="contact_number" name="contact_number" value="<?php echo e(isset($op->contact_number)?$op->contact_number:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="email" name="email" value="<?php echo e(isset($op->email)?$op->email:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="etin" name="etin" value="<?php echo e(isset($op->etin)?$op->etin:''); ?>"/>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="vat_number" name="vat_number" value="<?php echo e(isset($op->vat_number)?$op->vat_number:''); ?>"/>
