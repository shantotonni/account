<?php $__env->startSection('title', 'VLS Process'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            <?php endif; ?>
            <?php echo Form::open(['url' => route('visa_process_store'), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']); ?>
                                ...
                                <div class="uk-margin-top">
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <?php if($errors->has('recruit_id')): ?>

                                                <span style="color:red; position: relative; right:-500px"><?php echo $errors->first('recruit_id'); ?></span>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <?php if($errors->has('visa_number')): ?>
                                                ...
                                                <span style="color:red; position: relative; right:-500px"><?php echo $errors->first('visa_number'); ?></span>
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            ...
                                            <?php if($errors->has('remarks')): ?>
                                                ...
                                                <span style="color:red; position: relative; right:-500px"><?php echo $errors->first('remarks'); ?></span>
