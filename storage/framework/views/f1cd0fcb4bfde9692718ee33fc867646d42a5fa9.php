<?php $__env->startSection('title', 'Edit Police Clearance'); ?>
...
<body onsubmit="return myFunc();">
    <div class="uk-grid" ng-controller="InvoiceController">
        <div class="uk-width-large-10-10">
            ...
            <?php endif; ?>
            <?php echo Form::open(['url' => route('police_clearance_update',$recruit->police->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']); ?>
                            ...
                            <div class="uk-margin-top">
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Customer" id="customer_id" name="paxid" readonly>
                                            ...
                                            <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <?php if($value->id == $recruit->police->paxid): ?>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_1" name="submission_date" data-uk-datepicker="{format:'YYYY-MM-DD'}" value="<?php echo $recruit->police->submission_date; ?>">
                                    </div>
                                </div>
                                                    ...
                                                    <div class="uk-grid form_section" id="d_form_row">
                                                        <div class="uk-width-1-1">
                                                            <div class="uk-input-group">
                                                                ...
                                                                <input type="text" id="visaType" class="md-input" name="title[]" <?php echo e((!$recruit->police->policeClearanceFile)?'required':''); ?>/>
                                                                <br>
                                                                <br>
                                                                <input type="file" class="md-input" name="img_url[]" <?php echo e((!$recruit->police->policeClearanceFile)?'required':''); ?>>
                                ...
                                <?php $__currentLoopData = $recruit->police->policeClearanceFile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-5 uk-vertical-align">
                                            <label class="uk-vertical-align-middle" for="visaType">Upload File</label>
                                        </div>
