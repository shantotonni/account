<?php $__env->startSection('title', 'Manpower service Progress List'); ?>
                    ...
                    <div class="md-card">
                        ...
                        <div class="user_content">
                                    ...
                                    <?php $__currentLoopData = $progress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="uk-text-center">
                                                <a href="<?php echo route('manpower_service_hotel_edit',$value->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                                <a class="delete_btn"><i data-uk-tooltip="{pos:'top'}" title="Delete" class="md-icon material-icons">&#xE872;</i></a>
                                                <input type="hidden" class="hotel_id" value="<?php echo e($value->id); ?>">
                                            </td>
                                        </tr>
                            ...
                            <div class="md-fab-wrapper branch-create">
                                <a id="add_branch_button" href="<?php echo route('manpower_service_hotel_create'); ?>" class="md-fab md-fab-accent branch-create">
    ...
    <script>
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                if(id){
                    window.location.href = "<?php echo e(route('manpower_service_hotel_delete')); ?>"+"/"+id;
                }else {
                    window.location.href = "<?php echo e(route('manpower_service_hotel_delete')); ?>"+"/"+"%00";
                }
            })
        })
