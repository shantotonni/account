...
<?php $__env->startSection('content'); ?>
    <div class="uk-grid" ng-controller="ExpenseController">
        <div class="uk-width-large-10-10">
            <?php echo Form::open(['url' => route('order_expense_accounts_storeExpense',['id'=>$id]), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']); ?>
