<?php $__env->startSection('title', 'Medical slip'); ?>
                                    ...
                                    <?php $__currentLoopData = $basis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    <a href="<?php echo route('medical_slip_form_download',$value->medicalslip_id); ?>" class="batch-edit"><i class="material-icons">file_download</i></a>
                                                    <a href="<?php echo route('medical_slip_form_edit',$value->medicalslip_id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                                    <a class="delete_btn"><i data-uk-tooltip="{pos:'top'}" title="Delete" class="md-icon material-icons">&#xE872;</i></a>
                                                    <input type="hidden" class="form_medical_id" value="<?php echo e($value->medicalslip_id); ?>">
                                                </td>
                                            </tr>
