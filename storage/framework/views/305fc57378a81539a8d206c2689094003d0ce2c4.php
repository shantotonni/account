<?php $__env->startSection('title', 'Umrah  Gift Pack'); ?>
                        ...
                        <div class="md-card">
                            <div class="user_heading">
                                ...
                                <div class="user_heading_content">
                                    <h2 class="heading_b"><span class="uk-text-truncate">Gift Pack List</span></h2>
                                </div>
                            </div>
                                        ...
                                        <?php $__currentLoopData = $police; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    ...
                                                    <a href="<?php echo e(route('Umrah_GiftPack_edit',$value->id)); ?>"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
