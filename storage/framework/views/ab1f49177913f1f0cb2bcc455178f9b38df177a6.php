<?php $__env->startSection('title', 'Confirmed Ticket Order'); ?>
                            ...
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <div class="uk-modal" id="coustom_setting_modal">
                                    <div class="uk-modal-dialog">
                                        <?php echo Form::open(['url' => 'ticket/order/confirmed', 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'user_profile']); ?>
                                ...
                                <table class="uk-table" cellspacing="0" width="100%" id="data_table" >
                                    ...
                                    <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($value->contact['phone_number_1']); ?></td>
                                            <td><?php echo e($value['first_name']." ".$value['last_name']); ?></td>
                                            <td><?php echo e($value->updatedBy->name); ?></td>
                                            <td><?php echo e($value->departureSector); ?></td>
                                            <td><?php echo e($value->issuDate); ?></td>
                                            <td class="uk-text-center">

                                                <a href="<?php echo e(route('ticket_Order_pdf',['id' => $value->id])); ?>"><i class="material-icons">&#xE415;</i></a>
                                                <a href="<?php echo e(route('ticket_Order_bill_show',['id' => $value->bill_id?$value->bill_id:0,'order'=>$value->id])); ?>"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons <?php echo e($value->bill_id?' md-color-light-green-700': ''); ?>">B</i></a>
                                                <a href="<?php echo e(route('ticket_Order_invoice_show',['id' => $value->invoice_id?$value->invoice_id:0,'order'=>$value->id])); ?>"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons <?php echo e($value->invoice_id?' md-color-light-green-700': ''); ?>">I</i></a>
                                                <a href="<?php echo e(route('ticket_Order_edit',['id' => $value->id])); ?>"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
                                                ...
                                                <a href="<?php echo route('ticket_Order_sendMail',$value->id); ?>"><i class="material-icons">&#xE0BE;</i></a>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $('.delete_btn').click(function () {
            ...
            swal({
                ...
                window.location.href = "/ticket/order/destory/"+id;
            })
        })
    </script>
    ...
    <script type="text/javascript">
        $('#sidebar_ticket_order_confirm').addClass('act_item');
