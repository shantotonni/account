<?php $__env->startSection('title', 'Print Expense'); ?>
            ...
            <div class="uk-width-large-2-10 hidden-print uk-visible-large">
                <div class="md-list-outside-wrapper">
                    <ul class="md-list md-list-outside">
                        ...
                        <?php $__currentLoopData = $expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense_data): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <li>
                                <a href="<?php echo e(route('expense_show', ['id' => $expense_data->id])); ?>" class="md-list-content">
                                    <span class="md-list-heading uk-text-truncate"><?php echo e($expense_data->customer->display_name); ?></span>
                                    <span class="uk-text-small uk-text-muted"><?php echo e($expense_data->date); ?></span>
                                </a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>

                        <li class="uk-text-center">
                            <a class="md-btn md-btn-primary md-btn-mini md-btn-wave-light waves-effect waves-button waves-light uk-margin-top" href="<?php echo e(route('expense')); ?>">See All</a>
                        </li>
                    ...
                    <div id="invoice_preview">
                        <div class="md-card-toolbar hidden-print">
                            <div class="md-card-toolbar-actions hidden-print">
                                ...
                                <?php if($expense->save==1): ?>
                                    <a  href="<?php echo route('expense_update_mark',$expense->id); ?>" id="popup" style="float: left;margin-right: 15px" class="md-btn md-btn-primary md-btn-mini md-btn-wave-light waves-effect waves-button waves-light">Mark as Open</a>
                                <?php endif; ?>
                                ...
                                <div class="md-card-dropdown" data-uk-dropdown="{pos:'bottom-right'}" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="uk-dropdown" aria-hidden="true">
                                        <ul class="uk-nav">
                                            <li>
                                                <a href="<?php echo e(route('expense_edit', ['id' => $expense->id])); ?>">Edit</a>
                                            </li>
                                            <?php if($expense->file_url): ?>
                                                <li>
                                                    <a download href="<?php echo e(url($expense->file_url)); ?>">Attach File</a>
                                                </li>
                                             <?php endif; ?>

                                            <li>
                                                <a class="uk-text-danger" href="<?php echo e(route('expense_delete', ['id' => $expense->id])); ?>">Delete</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="md-card-content invoice_content print_bg" style="height: 301px;">
                            ...
                            <?php else: ?>
                                <div class="uk-grid" data-uk-grid-margin style="text-align: center;">
                                    <h1 style="width: 100%; text-align: center;"><img style="text-align: center; margin-top: 20px; " class="logo_regular" src="<?php echo e(url('uploads/op-logo/logo.png')); ?>" alt="" height="15" width="71"/> <?php echo e($OrganizationProfile->company_name); ?></h1>
                                </div>
                            ...
                            <?php endif; ?>
                            <h2 id="account_name" style="text-align: center;"><?php echo e($expense->account->account_name); ?> <br/> <span><?php echo e($expense->save?"Draft":''); ?></span> </h2>
                              <hr id="hrd" />
                                <div class="uk-grid">
                                    <div  style="width: 80%; margin: auto; " class="uk-width-medium-1-1">
                                    <table border="1" id="tiktok_table" width="100%">
                                        <caption align="center" style="text-align: center">#EXP-<?php echo e(str_pad($expense->expense_number,6,'0',STR_PAD_RIGHT)); ?></caption>

                                        <tr>
                                            <td>Expense Amount</td>
                                            <td><span>BDT <?php echo e($expense->amount); ?> <small>on <?php echo e($expense->date); ?></small></span></td>
                                        </tr>
                                        <?php if($expense->paid_through_id): ?>


                                                <tr>
                                                    <td>Paid Through</td>
                                                    <td><?php echo e($expense->accountPaidThrough->account_name); ?></td>
                                                </tr>
                                        <?php endif; ?>
                                        <?php if($expense->invoice_show == "on"): ?>
                                            <tr>
                                                <td> Bank Info</td>
                                                <td><?php echo e($expense->bank_info); ?></td>
                                            </tr>
                                        <?php endif; ?>
                                       <tr>
                                          <td>Tax Amount</td>
                                          <td>BDT <?php echo e($expense->tax_total); ?> <?php echo e($expense->tax_type == 1 ? '(Exclusive)' : '(Inclusive)'); ?></td>
                                       </tr>
                                       ...
                                       <tr>
                                           <td>Paid To</td>
                                           <td><?php echo e($expense->customer->display_name); ?></td>
                                       </tr>
