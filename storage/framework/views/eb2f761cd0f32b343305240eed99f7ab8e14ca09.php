            ...
            <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                <?php echo $__env->make('inc.customer_nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <div class="uk-width-xLarge-8-10  uk-width-large-8-10">
                        ...
                        <?php echo Form::open(['url' => array('customer/information/update', base64_encode($customer_info->id)), 'method' => 'post', 'class' => 'uk-form-stacked','files' => true]); ?>
                                        ...
                                        <div class="uk-margin-top">
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-medium-2-5">
                                                    ...
                                                    <input class="md-input" type="text" id="religionEN" name="passengerNameBN" value="<?php echo e($customer_info->passengerNameBN); ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-medium-2-5">
                                                    ...
                                                    <input class="md-input" type="text" id="religionEN" name="passportNumberBN" value="<?php echo e($customer_info->passportNumberBN); ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="uk-grid" data-uk-grid-margin>
                                                ...
                                                <div class="uk-width-medium-2-5">
                                                    ...
                                                    <input class="md-input" type="text" id="group" name="contact_number" value="<?php echo e($customer_info->contact_number); ?>" />
                                                </div>
                                            </div>
                                            <div class="uk-grid" data-uk-grid-margin>
                                                <div class="uk-width-medium-1-5 uk-vertical-align">
                                                ...
                                                <div class="uk-width-medium-1-2">
                                                    <?php if(count($subref)): ?>
                                                      <?php $__currentLoopData = $subref; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$name): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                    <div class="uk-grid form_section" data-section-added="<?php echo e($key); ?>">
                                                        <div class="uk-width-1-1">
                                                            <div class="uk-input-group">
                                                                <div class="md-input-wrapper"><input type="text" class="md-input" value="<?php echo e($name); ?>" name="sub_reference[]"><span class="md-input-bar "></span></div>
                                           ...
                                           <!-- <hr>
                                            ...
                                            <?php $__currentLoopData = $customer_info->contact_file; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <div class="uk-grid" data-uk-grid-margin>
                                                    <div class="uk-width-medium-1-5 uk-vertical-align">
                                                        <label class="uk-vertical-align-middle" for="visaType">Upload File</label>
                                                    </div>
                                                                ...
                                                                <div class="uk-grid form_section" id="d_form_row">
                                                                    <div class="uk-width-1-1">
                                                                        ...
                                                                        <div class="uk-input-group">
                                                                            ...
                                                                            <br>
                                                                            <br>
                                                                            <input id="img_url" type="file" class="md-input old" name="img_url[<?php echo 'old_'.$file['id']; ?>]">
