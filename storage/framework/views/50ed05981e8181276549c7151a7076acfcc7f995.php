...
<?php $__env->startSection('angular'); ?>
    ...
    <script src="<?php echo e(url('app/moneyout/bill/expenseEdit.controller.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <div class="uk-grid" ng-controller="ExpenseEditController">
        <div class="uk-width-large-10-10">
            <?php echo Form::open(['url' => route('expense_update', ['id' => $expense->id]), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']); ?>

            <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">

                        <input type="hidden" ng-init="expense_id='asdfg'" value="<?php echo e($expense->id); ?>" name="expense_id" ng-model="expense_id">
                            ...
                            <div class="uk-margin-top">
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <label for="Number"> <?php echo e(str_pad($expense->expense_number,6,'0',STR_PAD_RIGHT)); ?> </label>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="expense_date" name="expense_date" value="<?php echo e(date("d-m-Y", strtotime($expense->date))); ?>" data-uk-datepicker="{format:'DD-MM-YYYY'}" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Customer" id="account_id" name="account_id" required>
                                            ...
                                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <option value="<?php echo e($account->id); ?>" <?php echo e($account->id == $expense->account_id ? "selected='selected'" : ''); ?>><?php echo e($account->account_name); ?></option>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="amount" ng-model="amount" name="amount" value="<?php echo e($expense->amount); ?>" ng-keyup="calculateTax()" />
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div ng-if="account_type!=3" class="uk-width-medium-2-5" id="show">
                                        ...
                                        <input class="md-input" type="text" id="reference" name="bank_info" value="<?php echo e($expense->bank_info); ?>" />
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        <select data-md-selectize data-md-selectize-bottom data-uk-tooltip="{pos:'top'}" title="Select Customer" id="customer_id" name="customer_id" required>
                                            ...
                                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                <option value="<?php echo e($customer->id); ?>" <?php echo e($customer->id == $expense->vendor_id ? "selected='selected'" : ''); ?> ><?php echo e($customer->display_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="reference" name="reference" value="<?php echo e($expense->reference); ?>" />
                                    </div>
                                </div>
                                            ...
                                            <div class="uk-width-medium-1-1">
                                                ...
                                                <span>
                                                    <?php if($expense->file_url): ?>
                                                        <a download href="<?php echo e(url($expense->file_url)); ?>">download attachment </a>
                                                    <?php endif; ?>
                                                </span>
                                            </div>
                                            <div class="uk-width-medium-1-1">
                                    ...
                                    <div class="uk-width-medium-2-3">
                                        <div class="uk-grid" data-uk-grid-margin>
                                            <div class="uk-width-medium-1-1">
                                                ...
                                                <textarea class="md-input" id="customer_note" name="customer_note"> <?php echo e($expense->note); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
