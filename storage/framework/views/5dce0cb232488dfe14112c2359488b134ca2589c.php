                ...
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="user_content">
                            <?php echo Form::open(['url' => route('manpower_service_bill_store'), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']); ?>
                            ...
                            <div class="uk-margin-top">
                                ...
                                <div class="uk-grid uk-ma" data-uk-grid-margin>
                                    <div class="uk-width-1-1 uk-float-left">
                                        <input type="hidden" name="ticket_id" value="<?php echo e($progress); ?>">
