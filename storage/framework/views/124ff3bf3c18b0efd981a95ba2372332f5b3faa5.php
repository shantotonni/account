             ...
             <div class="md-card">
                 <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }">
                     ...
                     <div class="user_heading_content">
                         <h2 class="heading_b"><span class="uk-text-truncate">Customer Order Details</span></h2>
                     </div>
                 </div>
                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo $value->registerSerial_id; ?></td>
                                <td><?php echo $value->passportDate; ?></td>

                                <td class="uk-text-center">
                                    <a href="<?php echo route('order_edit',$value->id); ?>"  class="batch-edit"><i class="md-icon material-icons">&#xE254;</i></a>
                                </td>
                            </tr>
                        </tbody>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        $('.customer_orderdetails').addClass('md-bg-blue-grey-100');
    </script>
<?php $__env->stopSection(); ?>
