<?php $__env->startSection('title', 'Umrah  Training'); ?>
                        ...
                        <div class="md-card">
                            ...
                            <div class="user_content">
                                        ...
                                        <?php $__currentLoopData = $police; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="uk-text-center">
                                                    ...
                                                    <a href="<?php echo e(route('Umrah_Training_edit',$value->id)); ?>"><i data-uk-tooltip="{pos:'top'}" title="Edit" class="md-icon material-icons">&#xE254;</i></a>
                                ...
                                <div class="md-fab-wrapper branch-create">
                                    <a id="add_branch_button" href="<?php echo e(route('Umrah_Training_create')); ?>" class="md-fab md-fab-accent branch-create">
