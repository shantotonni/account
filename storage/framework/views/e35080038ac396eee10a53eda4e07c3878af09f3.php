                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i++; ?></td>
                                <td><?php echo $recruit->confirmation['date_of_flight']; ?></td>
                                <td><?php echo $recruit->confirmation['departure_time']; ?></td>
                                <td><?php echo $recruit->paxid; ?></td>
                                <td><?php echo isset($recruit->confirmation->vendorId)?$recruit->confirmation->vendorId['display_name']:''; ?></td>

                                <?php if($recruit->id==$recruit->confirmation['pax_id']): ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('confirmation_edit',$recruit->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                    </td>
                                <?php else: ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('confirmation_create',$recruit->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">+</i></a>
                                    </td>
                                <?php endif; ?>
