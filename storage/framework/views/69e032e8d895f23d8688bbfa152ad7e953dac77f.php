<?php $__env->startSection('title', 'Customer Manpower'); ?>
                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i++; ?></td>
                                <td><?php echo $recruit->manpower['issuingDate']; ?></td>
                                <td><?php echo $recruit->manpower['receivingDate']; ?></td>
                                <td><?php echo $recruit->paxid; ?></td>
                                <td><?php echo $recruit->manpower['comment']; ?></td>

                                <?php if($recruit->id==$recruit->manpower['paxid']): ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('manpower_edit',$recruit->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">&#xE254;</i></a>
                                    </td>
                                <?php else: ?>
                                    <td class="uk-text-center">
                                        <a href="<?php echo route('manpower_create',$recruit->id); ?>" class="batch-edit"><i class="md-icon material-icons uk-margin-right">+</i></a>
                                    </td>
                                <?php endif; ?>
