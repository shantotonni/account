...
<?php $__env->startSection('content'); ?>
    ...
    <div class="uk-grid" ng-controller="InvoiceController" >
        <div class="uk-width-large-10-10">
            ...
            <?php endif; ?>
            <?php echo Form::open(['url' => route('immigration_update',$immigration->id), 'method' => 'POST', 'class' => 'user_edit_form', 'id' => 'my_profile', 'files' => 'true', 'enctype' => "multipart/form-data", 'novalidate']); ?>
                            ...
                            <div class="uk-margin-top">
                                                    ...
                                                    <select id="selec_adv_1" name="pax_id[]" multiple>
                                                        ...
                                                        <?php $__currentLoopData = $immipax; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                                <?php if($value->id==$item->pax_id): ?>
                                                                    <option value="<?php echo $item->pax_id; ?>" selected><?php echo $item->recruit->paxid; ?></option>
                                                                <?php endif; ?>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->applicationDate; ?>" name="applicationDate" data-uk-datepicker="{format:'YYYY-MM-DD'}">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->country_name; ?>" name="country_name">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="number" id="uk_dp_start" value="<?php echo $immigration->total_person; ?>" name="total_person">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="number" id="uk_dp_start" value="<?php echo $immigration->person_count; ?>" name="person_count">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->gender; ?>" name="gender">
                                    </div>
                                </div>
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-5  uk-vertical-align">
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->stampFee; ?>" name="stampFee">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->licenseValidity; ?>" name="licenseValidity">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->authentication; ?>" name="authentication">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->unitWelfareFee; ?>" name="unitWelfareFee">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->WelfareComment; ?>" name="WelfareComment">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-1-3">
                                        <select id="select_demo_2" name="incomeTaxType" class="md-input income" data-uk-tooltip="{pos:'top'}" onchange="orderimageType()" title="Select with tooltip">
                                            ...
                                            <?php elseif($immigration->incomeTaxType==1): ?>
                                ...
                                <div class="uk-grid" data-uk-grid-margin id="na">
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->unitIncomeTaxNAFee; ?>" name="unitIncomeTaxNAFee">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin id="sa">
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->unitIncomeTaxSAFee; ?>"  name="unitIncomeTaxSAFee">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->incomeTaxComment; ?>" name="incomeTaxComment">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->SmartCardComment; ?>" name="SmartCardComment">
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    ...
                                    <div class="uk-width-medium-2-5">
                                        ...
                                        <input class="md-input" type="text" id="uk_dp_start" value="<?php echo $immigration->payOrderDetails; ?>" name="payOrderDetails">
                                    </div>
                                </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function load() {
            var cancal = "<?php echo e($immigration->incomeTaxType); ?>";
