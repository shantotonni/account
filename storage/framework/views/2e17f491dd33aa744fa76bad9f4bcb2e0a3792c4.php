            ...
            <div class="uk-grid uk-grid-medium" data-uk-grid-margin>
                <div class="uk-width-xLarge-10-10 uk-width-large-10-10">
                    <div class="md-card">
                        ...
                        <div class="md-card">
                            <?php echo Form::open(['url' => route('mofa_update',$mofa->id), 'method' => 'POST']); ?>
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-medium-2-5">
                                            <p>
                                                <input <?php echo e($mofa->status? "checked":''); ?>  value="1" type="radio" name="status" id="status" data-md-icheck />
                                                <label  for="radio_demo_1"  class="inline-label">ok</label>
                                            </p>
                                            <p>
                                                <input <?php echo e($mofa->status? '':'checked'); ?> type="radio" value="0" name="status"  id="status" data-md-icheck />
