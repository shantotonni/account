                            ...
                            <div class="uk-grid">
                                ...
                                <div class="uk-width-small-1-2">
                                    ...
                                    <table id="info" class="uk-table inv_top_right_table">
                                        ...
                                        <?php if(isset($bill->Ticket)): ?>
                                            <tr style="white-space:nowrap; line-height: 10px;">
                                                <td class="uk-text-right "> Passenger Name</td>
                                                <td style="white-space:nowrap; text-align: right"><?php echo strlen($bill->Ticket->first_name)>25?$bill->Ticket->first_name."<br/>":$bill->Ticket->first_name." "; ?> <?php echo e($bill->Ticket->last_name); ?> </td>
                                            </tr>

                                            <tr >
                                                <td class="uk-text-right " style="word-wrap: break-word"> Ticket Number</td>
                                                <td class="uk-text-right "><?php echo e($bill->Ticket->ticket_number); ?></td>
                                            </tr>
                                         <?php endif; ?>
                                    </table>
                                </div>
                            ...
                            <div class="uk-grid uk-margin-large-bottom">
                                <div class="uk-width-1-1">
                                    <table id="table_center" border="1" class="uk-table">
                                        ...
                                        <tr class="uk-table-middle">
                                            <td>1</td>
                                            <td><?php echo e($bill_entry->item->item_name); ?> <?php if($bill_entry->description): ?><br><?php echo e($bill_entry->description); ?><?php endif; ?></td>
